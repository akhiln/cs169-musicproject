...
describe SongsController do
  ...
  describe "GET index" do
    it "assigns all songs as @songs" do
      Song.stub(:find).with(:all).and_return([mock_song])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested song as @song" do
      Song.stub(:find).with("37").and_return(mock_song)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new song as @song" do
      Song.stub(:new).and_return(mock_song)
      get :new
      assigns[:song].should equal(mock_song)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created song as @song" do
        Song.stub(:new).with({'these' => 'params'}).and_return(mock_song(:save => true))
